...
return new class extends Migration
{
    ...
    {
        if (DB::connection()->getDriverName() !== 'sqlite') { DB::statement('ALTER TABLE `translations` MODIFY `key` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL'); }
    }
    ...
    public function down(): void
    {
        ...
        if (DB::connection()->getDriverName() !== 'sqlite') { DB::statement('ALTER TABLE `translations` MODIFY `key` VARCHAR(191) CHARACTER SET utf8mb4 NOT NULL'); }
    }
};
