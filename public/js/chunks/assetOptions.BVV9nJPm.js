import{B as t,aY as r,d9 as n,ar as o}from"../app.CNuDfSdb.js";import{B as c}from"./boxes.CAlHaZg4.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p=t("laptop",[["path",{d:"M18 5a2 2 0 0 1 2 2v8.526a2 2 0 0 0 .212.897l1.068 2.127a1 1 0 0 1-.9 1.45H3.62a1 1 0 0 1-.9-1.45l1.068-2.127A2 2 0 0 0 4 15.526V7a2 2 0 0 1 2-2z",key:"1pdavp"}],["path",{d:"M20.054 15.987H3.946",key:"14rxg9"}]]),f=[{value:"in_use",label:"In use",color:"success"},{value:"maintenance",label:"In maintenance",color:"warning"},{value:"retired",label:"Retired",color:"default"}],k=[{value:"service",label:"Service",color:"blue"},{value:"repair",label:"Repair",color:"volcano"},{value:"inspection",label:"Inspection",color:"cyan"},{value:"calibration",label:"Calibration",color:"purple"},{value:"upgrade",label:"Upgrade",color:"geekblue"},{value:"other",label:"Other",color:"default"}],g=[{value:"scheduled",label:"Scheduled",color:"processing"},{value:"in_progress",label:"In progress",color:"warning"},{value:"completed",label:"Completed",color:"success"},{value:"cancelled",label:"Cancelled",color:"default"}],y=[{value:"assigned",label:"Out",color:"processing"},{value:"returned",label:"Returned",color:"success"}],M=[{value:"none",label:"None",hint:"Book value stays at cost"},{value:"straight_line",label:"Straight line",hint:"Equal charge every month of the life"},{value:"declining_balance",label:"Declining balance",hint:"Double rate on the remaining value — front-loaded"}],s=[{match:/laptop|computer|pc|it|electronic/i,icon:p},{match:/tool|equipment|machine/i,icon:r},{match:/vehicle|car|truck|van/i,icon:n},{match:/furniture|chair|desk|office/i,icon:i},{match:/building|property|premise|land/i,icon:u},{match:/server|network|hardware/i,icon:h},{match:/stock|material|supply/i,icon:c}];function m(e){const a=s.find(l=>l.match.test(e||""));return a?a.icon:o}function d(e,a){return e.find(l=>l.value===a)||{value:a,label:a||"—",color:"default"}}function S(e,a){return d(e,a).label}function T(e){return e==null?"default":e<0?"error":e<=7?"warning":e<=30?"processing":"success"}function E(e){return e==null?"—":e<0?`${Math.abs(e)} day${Math.abs(e)===1?"":"s"} late`:e===0?"Today":`in ${e} day${e===1?"":"s"}`}export{f as A,M as D,k as M,E as a,y as b,m as c,T as d,g as e,S as l,d as o};
