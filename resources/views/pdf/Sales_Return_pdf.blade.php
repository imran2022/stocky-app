                ...
                <div style="border: 1px solid #e5e7eb; border-radius: 4px; overflow: hidden;">
                    ...
                    <div style="padding: 8px 10px; background: #fef2f2;">
                        ...
                        <table style="width: 100%; font-size: 7.5pt; color: #6b7280; line-height: 1.5;" cellpadding="0" cellspacing="0">
                            ...
                            <tr><td style="padding: 1px 0; vertical-align: top; text-align: left; direction: ltr;">{{$setting['vat_number']}}</td><td style="padding: 1px 0; vertical-align: top; text-align: right; direction: rtl;"><strong style="color: #1f2937;">{{ __('pdf.vat_number') }}</strong></td></tr>
                            @endif
                            @if(!empty($setting['website']))
                            <tr><td style="padding: 1px 0; vertical-align: top; text-align: left; direction: ltr;">{{$setting['website']}}</td><td style="padding: 1px 0; vertical-align: top; text-align: right; direction: rtl;"><strong style="color: #1f2937;">{{ __('pdf.website') }}</strong></td></tr>
                            @endif
                            @else
                            ...
                            @if(!empty($setting['vat_number']))
                            <tr><td style="padding: 1px 0; vertical-align: top; text-align: left;"><strong style="color: #1f2937;">{{ __('pdf.vat_number') }}:</strong></td><td style="padding: 1px 0; vertical-align: top; text-align: left;">{{$setting['vat_number']}}</td></tr>
                            @endif
                            @if(!empty($setting['website']))
                            <tr><td style="padding: 1px 0; vertical-align: top; text-align: left;"><strong style="color: #1f2937;">{{ __('pdf.website') }}:</strong></td><td style="padding: 1px 0; vertical-align: top; text-align: left;">{{$setting['website']}}</td></tr>
                            @endif
                            @endif
                        </table>
                    </div>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 10px; border: 1px solid #e5e7eb;" cellpadding="0" cellspacing="0" {{ $isRtl ? 'dir="rtl"' : '' }}>
        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #e5e7eb; background: {{$rowIndex % 2 == 0 ? '#ffffff' : '#fef2f2'}};">
                ...
                <td style="padding: 5px; text-align: right; font-size: 8.5pt; color: #10b981;">{{formatPrice((float)$detail['DiscountNet'] * (float)$detail['quantity'], 2, $priceFormat)}}</td>
                <td style="padding: 5px; text-align: right; font-size: 8.5pt; color: #1f2937;">{{formatPrice((float)$detail['taxe'] * (float)$detail['quantity'], 2, $priceFormat)}}</td>
